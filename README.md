...
For this challenge,an interactive dashboard was built using the Plotly library in JavaScript to explore the Belly Button Biodiversity dataset which catalogs the microbes that colonize human navels. Further infomation: http://robdunnlab.com/projects/belly-button-biodiversity/
